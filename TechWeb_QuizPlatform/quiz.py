...
def create_quiz():
   if request.method == 'POST':
	   ...
	   resp = make_response(render_template('question_type.html',quiz_id=quiz.id,visibility="visible"))
...
def define_question():
	...
	if str(question_type) == 'me':
		return render_template('question_me.html')
	if str(question_type) == 'dissertativa':
		return render_template('question_dissertativa.html')

@app.route('/question_dissertativa', methods=['GET','POST'])
def question_me():
	if request.method == 'POST':
		return render_template('questionlist.html')
	return render_template('question_dissertativa.html')

@app.route('/question_me', methods=['GET','POST'])
def question_dissertativa():
	if request.method == 'POST':

		#print(request.values)
		question = request.form["question"]

		num = request.form['num_alternativas']
		
		return render_template('testenum.html', num=num, question=question)
	return render_template('question_me.html',visibility="hidden")
